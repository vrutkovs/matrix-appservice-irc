...
function IrcBridge(config, registration) {
    ...
    this.matrixToIrcBridgers = {
    //  domain: MatrixToIrcBridger
    }
}

IrcBridge.prototype.getMatrixToIrcBridger = function(domain) {
    return this.matrixToIrcBridgers[domain] || null;
};

IrcBridge.prototype.getMemberListSyncer = function(domain) {
    return this.memberListSyncers[domain] || null;
};
