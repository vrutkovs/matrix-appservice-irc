 ...
 * finishes.
 */
module.exports.onPrivateMessage = function(server: IrcServer, fromUser: IrcUser,
                                           toUser: IrcUser, action: IrcAction): Promise {
    ...
    var virtualMatrixUser = {}; // sender FIXME pass this in!
 ...
 */
module.exports.onMessage = function(server: IrcServer, fromUser: IrcUser,
                                    channel: string, action: IrcAction): Promise {
    if (fromUser.isVirtual) {
        return q.reject(requests.ERR_VIRTUAL_USER);
    }
 ...
 * @return {Promise} which is resolved/rejected when the request finishes.
 */
module.exports.onJoin = function(server: IrcServer, joiningUser: IrcUser,
                                 chan: string, kind: string): Promise {
    ...
    if (joiningUser.isVirtual) {
        ...
        return req.getPromise(); // don't send stuff which were sent from bots
    }
 ...
 * @return {Promise} which is resolved/rejected when the request finishes.
 */
module.exports.onPart = function(server: IrcServer, leavingUser: IrcUser,
                                 chan: string, kind: string): Promise {
    ...
    // get virtual matrix user
    var matrixUser = {}; // FIXME: Pass this in!
...
module.exports.onMode = function(server: IrcServer, channel: string, by: string,
                                 mode: string, enabled: boolean, arg: string) {
