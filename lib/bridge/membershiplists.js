...
import {IrcRoom} from "./../models/rooms";
...
module.exports.sync = function(server: IrcServer) {
...
module.exports.getChannelsToJoin = function(server: Object): Promise<Array<String>> {
...
module.exports.checkBotPartRoom = function(ircRoom: IrcRoom, req: Request) {
...
function getSyncableRooms(server: IrcServer): Promise<Array<Object>> {
...
function joinMatrixUsersToChannels(rooms: Array<Object>, server: IrcServer): Promise {
    var d = q.defer();
...
function leaveIrcUsersFromRooms(rooms: Array<Object>, server: IrcServer) {
    return q();
}

function getRoomMemberData(server: IrcServer, roomId: string,
                           stateEvents: Array<Object>): Object {
...
function injectJoinEvent(roomId: string, userId: string): QPromise {
    var target = new MatrixUser(userId, null, false);
