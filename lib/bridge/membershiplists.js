...
module.exports.getChannelsToJoin = function(server: Object) {
...
module.exports.checkBotPartRoom = function(ircRoom: Object, req: Object) {
...
function getSyncableRooms(server: Object) {
...
function joinMatrixUsersToChannels(rooms: Array<Object>, server: Object) {
    var d = q.defer();
...
function injectJoinEvent(roomId: string, userId: string) {
