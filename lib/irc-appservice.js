...
var IrcServer = require("./irclib/server.js");
...
var prepareDatabase = function(config: Object): Promise {
    if (dbConnPromise) {
...
module.exports.generateRegistration = function(config: Object):
                                      Promise<AppServiceRegistration> {
...
module.exports.runService = function(appService: AppService, config: Object,
                                     skipCrcCheck: boolean): Promise {
    if (config.logging) {
...
module.exports.startup = function(as: AppService, servers: Array<IrcServer>,
                                  dbToken: string, config: Object) {
    ...
    as.on("type:m.room.member", function(event) {
        ...
        var target = new MatrixUser(event.state_key, null, false);
        var sender = new MatrixUser(event.user_id, null, false);
...
module.exports.createHomeserverToken = function(config: Object): string {
...
module.exports.isValidHomeserverToken = function(storedToken: string,
                                                 liveConfig: Object): boolean {
