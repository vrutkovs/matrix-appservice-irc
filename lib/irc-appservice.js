...
module.exports.runService = function(config, skipCrcCheck) {
    if (config.logging) {
    ...
    prepareDatabase(config).then(function() {
        ...
        module.exports.startup(globalServers, dbToken, config);
    }).done();

};

module.exports.startup = function(servers, dbToken, config) {
    console.log("starting up");
    ircLib.setServers(servers);
    var as = new AppService({
        homeserverToken: dbToken
    });
