...
class BridgedClient extends EventEmitter {
     ...
     */
    connect(callbacks: Object): Object {
    ...
    disconnect(reason: string): Object {
     ...
     */
    changeNick(newNick: string): Object {
    ...
    joinChannel(channel: string): Object {
        if (this.disabled) { return q("disabled"); }
        return joinChannel(this, channel);
    }

    leaveChannel(channel: string): Object {
        if (this.disabled) { return q("disabled"); }
        if (!this.inst || this.inst.dead) {
    ...
    sendAction(room: IrcRoom, action: IrcAction): Object {
        if (this.disabled) { return q("disabled"); }
        this._keepAlive();
    ...
    _onConnectionCreated(connInst: Object, nameInfo: Object, callbacks: Object) {
        var self = this;
