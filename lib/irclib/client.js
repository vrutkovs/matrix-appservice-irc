...
class BridgedClient extends EventEmitter {
    ...
    joinChannel(channel: string): Promise<String> {
        ...
        return joinChannel(this, channel, 1);
    }
...
var setTopic = function(bridgedClient, room, topic) {
    ...
    var defer = q.defer();
    joinChannel(bridgedClient, room.channel, 1).done(function() {
...
var sendMessage = function(bridgedClient, room, msgType, text) {
    ...
    bridgedClient._connectDefer.promise.then(function() {
        return joinChannel(bridgedClient, room.channel, 1);
    }).done(function() {
        if (msgType == "action") {
...
function joinChannel(bridgedClient, channel, attemptCount: number) {
