...
module.exports.irc = {
    createMessage: function(text: string): IrcAction {
        return new IrcAction(ACTIONS.MESSAGE, text);
    },
    createEmote: function(text: string): IrcAction {
        return new IrcAction(ACTIONS.EMOTE, text);
    },
    createNotice: function(notice: string): IrcAction {
        return new IrcAction(ACTIONS.NOTICE, notice);
    },
    createTopic: function(topic: string): IrcAction {
        return new IrcAction(ACTIONS.TOPIC, topic);
    }
};

module.exports.matrix = {
    createNotice: function(text: string): MatrixAction {
        return new MatrixAction(ACTIONS.NOTICE, text);
    },
    createAction: function(event: Object): ?MatrixAction {
