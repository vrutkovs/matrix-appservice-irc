...
class MatrixUser {
     ...
     */
    constructor(userId: string, displayName: ?string, isVirtual: boolean) {
...
class IrcUser {
     ...
     */
    constructor(server: IrcServer, nick: string, isVirtual: boolean,
    ...
    toString(): string {
        return this.nick + " (" + (this.username ? this.username : "-") + "@" +
