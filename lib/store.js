...
var userStore: ?UserBridgeStore = null;
...
module.exports.users = {
    ...
    set: function(user: MatrixUser, localpart: string, displayName: string,
        ...
        return userStore.storeMatrixUser(mxUser);
    }
};
...
module.exports.ircClients = {
    get: function(userId: string, domain: string): Promise<IrcUser> {
        ...
        var d = q.defer();
        userStore.getByJungleId(mkJungleId(domain, userId)).then(function(jungleUser) {
            if (!jungleUser) {
                d.resolve(null);
                return;
            }
    ...
    set: function(userId: string, ircUser: IrcUser): Promise {
        ...
        userStore.storeJungleUser(jungleUser).then(function() {
            return userStore.linkUserIds(userId, jungleUser.getId());
        }).done(function() {
            d.resolve();
        }, function(err) {
            d.reject(err);
